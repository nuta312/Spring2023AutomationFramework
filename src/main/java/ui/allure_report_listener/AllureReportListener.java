package ui.allure_report_listener;
...
public class AllureReportListener implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        iTestContext.setAttribute("WebDriver", MainDriver.getDriver());
    }
    @Override
